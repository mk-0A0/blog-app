...
export type UpdatePostMutation = { __typename?: 'Mutation', updatePost: { __typename?: 'Post', content: string, title: string, categories: Array<{ __typename?: 'Category', id: string, name: string, uuid: string }> } };
