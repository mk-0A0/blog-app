...
export type PostDetailQuery = { __typename?: 'Query', post: { __typename?: 'Post', uuid: string, content: string, title: string, categories: Array<{ __typename?: 'Category', id: string, name: string, uuid: string }>, author: { __typename?: 'User', email: string, name: string } } };
